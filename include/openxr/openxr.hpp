...
struct Version {
    ...
    explicit Version(uint64_t version)
        : Version()
    {
...
public:
    ...
    OPENXR_HPP_CONSTEXPR explicit Duration(XrDuration v) noexcept
        : val_(v)
    {
    }
    //! @}
...
public:
    ...
    OPENXR_HPP_CONSTEXPR explicit Time(XrTime v) noexcept
        : val_(v)
    {
    }
    //! @}
...
public:
    ...
    OPENXR_HPP_CONSTEXPR explicit SystemId(XrSystemId v) noexcept
        : val_(v)
    {
    }
    //! @}
...
public:
    ...
    OPENXR_HPP_CONSTEXPR explicit Path(XrPath v) noexcept
        : val_(v)
    {
    }
    //! @}
...
template <typename T>
struct ResultValue {
    ResultValue(Result r, T const& v)
        : result(r)
        , value(v)
    {
    }
...
public:
    ...
    OPENXR_HPP_CONSTEXPR Instance() noexcept
        : val_(XR_NULL_HANDLE)
    {
    }
...
public:
     ...
     */
    //! Default (empty/null) constructor
    OPENXR_HPP_CONSTEXPR Session() noexcept
        : val_(XR_NULL_HANDLE)
    {
    }
...
public:
     ...
     */
    //! Default (empty/null) constructor
    OPENXR_HPP_CONSTEXPR Space() noexcept
        : val_(XR_NULL_HANDLE)
    {
    }
...
public:
     ...
     */
    //! Default (empty/null) constructor
    OPENXR_HPP_CONSTEXPR Action() noexcept
        : val_(XR_NULL_HANDLE)
    {
    }
...
public:
     ...
     */
    //! Default (empty/null) constructor
    OPENXR_HPP_CONSTEXPR Swapchain() noexcept
        : val_(XR_NULL_HANDLE)
    {
    }
...
public:
     ...
     */
    //! Default (empty/null) constructor
    OPENXR_HPP_CONSTEXPR ActionSet() noexcept
        : val_(XR_NULL_HANDLE)
    {
    }
...
public:
     ...
     */
    //! Default (empty/null) constructor
    OPENXR_HPP_CONSTEXPR SpatialAnchorMSFT() noexcept
        : val_(XR_NULL_HANDLE)
    {
    }
...
namespace traits {
    ...
    protected:
        TypedStructTraits(StructureType type_)
            : type(type_)
        {
        }
...
protected:
    EventDataBaseHeader(StructureType type_)
        : Parent(type_)
    {
    }
};
...
protected:
    SwapchainImageBaseHeader(StructureType type_)
        : Parent(type_)
    {
    }
};
...
protected:
    HapticBaseHeader(StructureType type_)
        : Parent(type_)
    {
    }
};
